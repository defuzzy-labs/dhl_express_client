...
accept_language = 'eng' # str |  (optional) (default to eng)
...
try:
    # Track a single DHL Express Shipment
    api_response = api_instance.exp_api_shipments_tracking(shipment_tracking_number, tracking_view=tracking_view, level_of_detail=level_of_detail, message_reference=message_reference, message_reference_date=message_reference_date, accept_language=accept_language, plugin_name=plugin_name, plugin_version=plugin_version, shipping_system_platform_name=shipping_system_platform_name, shipping_system_platform_version=shipping_system_platform_version, webstore_platform_name=webstore_platform_name, webstore_platform_version=webstore_platform_version)
    pprint(api_response)
 ...
 **accept_language** | **str**|  | [optional] [default to eng]
