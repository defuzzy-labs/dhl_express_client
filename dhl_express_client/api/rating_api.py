...
class RatingApi(object):
    ...
    def exp_api_landed_cost(self, body, x_version, **kwargs):  # noqa: E501
        """Landed Cost  # noqa: E501

        The Landed Cost section allows further information around products being sold to be provided. In return the duty, tax and shipping charges are calculated in real time and provides transparency about any extra costs the buyer may have to pay before they reach them.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_landed_cost(body, x_version, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SupermodelIoLogisticsExpressLandedCostRequest body: Details about the requested shipment (required)
        ...
        if kwargs.get('async_req'):
            return self.exp_api_landed_cost_with_http_info(body, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_landed_cost_with_http_info(body, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_landed_cost_with_http_info(self, body, x_version, **kwargs):  # noqa: E501
        """Landed Cost  # noqa: E501

        The Landed Cost section allows further information around products being sold to be provided. In return the duty, tax and shipping charges are calculated in real time and provides transparency about any extra costs the buyer may have to pay before they reach them.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_landed_cost_with_http_info(body, x_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method exp_api_landed_cost" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `exp_api_landed_cost`")  # noqa: E501
        # verify the required parameter 'x_version' is set
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_landed_cost`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SupermodelIoLogisticsExpressRates',  # noqa: E501
    ...
    def exp_api_rates(self, account_number, origin_country_code, origin_city_name, destination_country_code, destination_city_name, weight, length, width, height, planned_shipping_date, is_customs_declarable, unit_of_measurement, x_version, **kwargs):  # noqa: E501
        """Retrieve Rates for a one piece Shipment  # noqa: E501

        The Rate request will return DHL's product capabilities and prices (where applicable) based on the input data. Using the shipper and receiver address as well as the dimension and weights of the pieces belonging to a shipment, this operation returns the available products including the shipping price (where applicable)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_rates(account_number, origin_country_code, origin_city_name, destination_country_code, destination_city_name, weight, length, width, height, planned_shipping_date, is_customs_declarable, unit_of_measurement, x_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_rates_with_http_info(account_number, origin_country_code, origin_city_name, destination_country_code, destination_city_name, weight, length, width, height, planned_shipping_date, is_customs_declarable, unit_of_measurement, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_rates_with_http_info(account_number, origin_country_code, origin_city_name, destination_country_code, destination_city_name, weight, length, width, height, planned_shipping_date, is_customs_declarable, unit_of_measurement, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_rates_with_http_info(self, account_number, origin_country_code, origin_city_name, destination_country_code, destination_city_name, weight, length, width, height, planned_shipping_date, is_customs_declarable, unit_of_measurement, x_version, **kwargs):  # noqa: E501
        """Retrieve Rates for a one piece Shipment  # noqa: E501

        The Rate request will return DHL's product capabilities and prices (where applicable) based on the input data. Using the shipper and receiver address as well as the dimension and weights of the pieces belonging to a shipment, this operation returns the available products including the shipping price (where applicable)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_rates_with_http_info(account_number, origin_country_code, origin_city_name, destination_country_code, destination_city_name, weight, length, width, height, planned_shipping_date, is_customs_declarable, unit_of_measurement, x_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('account_number' not in params or
            ...
            raise ValueError("Missing the required parameter `account_number` when calling `exp_api_rates`")  # noqa: E501
        ...
        if ('origin_country_code' not in params or
            ...
            raise ValueError("Missing the required parameter `origin_country_code` when calling `exp_api_rates`")  # noqa: E501
        # verify the required parameter 'origin_city_name' is set
        if ('origin_city_name' not in params or
                params['origin_city_name'] is None):
            raise ValueError("Missing the required parameter `origin_city_name` when calling `exp_api_rates`")  # noqa: E501
        ...
        if ('destination_country_code' not in params or
            ...
            raise ValueError("Missing the required parameter `destination_country_code` when calling `exp_api_rates`")  # noqa: E501
        ...
        if ('destination_city_name' not in params or
            ...
            raise ValueError("Missing the required parameter `destination_city_name` when calling `exp_api_rates`")  # noqa: E501
        # verify the required parameter 'weight' is set
        if ('weight' not in params or
                params['weight'] is None):
            raise ValueError("Missing the required parameter `weight` when calling `exp_api_rates`")  # noqa: E501
        # verify the required parameter 'length' is set
        if ('length' not in params or
                params['length'] is None):
            raise ValueError("Missing the required parameter `length` when calling `exp_api_rates`")  # noqa: E501
        # verify the required parameter 'width' is set
        if ('width' not in params or
                params['width'] is None):
            raise ValueError("Missing the required parameter `width` when calling `exp_api_rates`")  # noqa: E501
        # verify the required parameter 'height' is set
        if ('height' not in params or
                params['height'] is None):
            raise ValueError("Missing the required parameter `height` when calling `exp_api_rates`")  # noqa: E501
        ...
        if ('planned_shipping_date' not in params or
            ...
            raise ValueError("Missing the required parameter `planned_shipping_date` when calling `exp_api_rates`")  # noqa: E501
        ...
        if ('is_customs_declarable' not in params or
            ...
            raise ValueError("Missing the required parameter `is_customs_declarable` when calling `exp_api_rates`")  # noqa: E501
        ...
        if ('unit_of_measurement' not in params or
            ...
            raise ValueError("Missing the required parameter `unit_of_measurement` when calling `exp_api_rates`")  # noqa: E501
        # verify the required parameter 'x_version' is set
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_rates`")  # noqa: E501
    ...
    def exp_api_rates_many(self, body, x_version, **kwargs):  # noqa: E501
        """Retrieve Rates for Multi-piece Shipments  # noqa: E501

        The Rate request will return DHL's product capabilities and prices (where applicable) based on the input data. Using the shipper and receiver address as well as the dimension and weights of the pieces belonging to a shipment, this operation returns the available products including the shipping price (where applicable)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_rates_many(body, x_version, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SupermodelIoLogisticsExpressRateRequest body: Details about the requested shipment (required)
        :param str x_version: Interface version - do not change this field value  (required)
        :param str message_reference: Please provide message reference 
        :param str message_reference_date: Optional reference date in the  HTTP-date format https://tools.ietf.org/html/rfc7231#section-7.1.1.2
        :param str plugin_name: Please provide name of the plugin (applicable to 3PV only) 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_rates_many_with_http_info(body, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_rates_many_with_http_info(body, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_rates_many_with_http_info(self, body, x_version, **kwargs):  # noqa: E501
        """Retrieve Rates for Multi-piece Shipments  # noqa: E501

        The Rate request will return DHL's product capabilities and prices (where applicable) based on the input data. Using the shipper and receiver address as well as the dimension and weights of the pieces belonging to a shipment, this operation returns the available products including the shipping price (where applicable)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_rates_many_with_http_info(body, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_version', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version', 'strict_validation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method exp_api_rates_many" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `exp_api_rates_many`")  # noqa: E501
        # verify the required parameter 'x_version' is set
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_rates_many`")  # noqa: E501
