...
class PickupApi(object):
    ...
    def exp_api_pickups(self, body, x_version, **kwargs):  # noqa: E501
        ...
        >>> thread = api.exp_api_pickups(body, x_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.exp_api_pickups_with_http_info(body, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_pickups_with_http_info(body, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_pickups_with_http_info(self, body, x_version, **kwargs):  # noqa: E501
        """Create a DHL Express pickup booking request  # noqa: E501

        The Pickup service creates a DHL Express pickup booking request   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_pickups_with_http_info(body, x_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_version' not in params or
            ...
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_pickups`")  # noqa: E501
    ...
    def exp_api_pickups_cancel(self, dispatch_confirmation_number, requestor_name, reason, x_version, **kwargs):  # noqa: E501
        """Cancel a DHL Express pickup booking request  # noqa: E501

        The Cancel Pickup service can be used to cancel a DHL Express pickup booking request. Delete of a previous successful pickups are subject to entire consolidated pickup if applicable.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_pickups_cancel(dispatch_confirmation_number, requestor_name, reason, x_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_pickups_cancel_with_http_info(dispatch_confirmation_number, requestor_name, reason, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_pickups_cancel_with_http_info(dispatch_confirmation_number, requestor_name, reason, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_pickups_cancel_with_http_info(self, dispatch_confirmation_number, requestor_name, reason, x_version, **kwargs):  # noqa: E501
        """Cancel a DHL Express pickup booking request  # noqa: E501

        The Cancel Pickup service can be used to cancel a DHL Express pickup booking request. Delete of a previous successful pickups are subject to entire consolidated pickup if applicable.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_pickups_cancel_with_http_info(dispatch_confirmation_number, requestor_name, reason, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['dispatch_confirmation_number', 'requestor_name', 'reason', 'x_version', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_pickups_cancel`")  # noqa: E501
    ...
    def exp_api_pickups_update(self, body, x_version, dispatch_confirmation_number, **kwargs):  # noqa: E501
        """Update pickup information for an existing DHL Express pickup booking request  # noqa: E501

        The Update Pickup service can be used to update pickup information for an existing DHL Express pickup booking request. Update of a previous successful pickups are subject to entire consolidated pickup if applicable.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_pickups_update(body, x_version, dispatch_confirmation_number, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_pickups_update_with_http_info(body, x_version, dispatch_confirmation_number, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_pickups_update_with_http_info(body, x_version, dispatch_confirmation_number, **kwargs)  # noqa: E501
            return data

    def exp_api_pickups_update_with_http_info(self, body, x_version, dispatch_confirmation_number, **kwargs):  # noqa: E501
        """Update pickup information for an existing DHL Express pickup booking request  # noqa: E501

        The Update Pickup service can be used to update pickup information for an existing DHL Express pickup booking request. Update of a previous successful pickups are subject to entire consolidated pickup if applicable.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_pickups_update_with_http_info(body, x_version, dispatch_confirmation_number, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_version', 'dispatch_confirmation_number', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_pickups_update`")  # noqa: E501
        # verify the required parameter 'dispatch_confirmation_number' is set
        if ('dispatch_confirmation_number' not in params or
                params['dispatch_confirmation_number'] is None):
