...
class IdentifierApi(object):
    ...
    def exp_api_identifiers(self, account_number, type, size, **kwargs):  # noqa: E501
        ...
        >>> thread = api.exp_api_identifiers(account_number, type, size, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.exp_api_identifiers_with_http_info(account_number, type, size, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_identifiers_with_http_info(account_number, type, size, **kwargs)  # noqa: E501
            return data

    def exp_api_identifiers_with_http_info(self, account_number, type, size, **kwargs):  # noqa: E501
        """Service to allocate identifiers upfront for DHL Express Breakbulk or Loose Break Bulk shipments  # noqa: E501

        Service to allocate identifiers upfront for DHL Express Breakbulk or Loose Break Bulk shipments. Requires authorization to use this service from DHL Express.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_identifiers_with_http_info(account_number, type, size, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account_number', 'type', 'size', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
