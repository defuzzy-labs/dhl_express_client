...
class ShipmentApi(object):
    ...
    def exp_api_shipments(self, body, x_version, **kwargs):  # noqa: E501
        ...
        >>> thread = api.exp_api_shipments(body, x_version, async_req=True)
        >>> result = thread.get()
        ...
        :param bool validate_data_only: If set to true, indicate to perform shipment data compliant validation on the shipment information.
        ...
        if kwargs.get('async_req'):
            return self.exp_api_shipments_with_http_info(body, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_with_http_info(body, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_with_http_info(self, body, x_version, **kwargs):  # noqa: E501
        """Create Shipment  # noqa: E501

        ## Create Shipment The ShipmentRequest Operation will allow you to generate an AWB number and piece IDs, generate a shipping label, transmit manifest shipment detail to DHL, and optionally book a courier for the pickup of a shipment. The key elements in the response of the Shipment Request will be a base64 encoded PDF label and the Shipment and Piece identification numbers, which you can use for tracking on the DHL web site. While the RateRequest and ShipmentRequest services can be used independently, DHL recommends the use of RateRequest to first validate the products available for the shipper/receiver. The global product codes which are output during the RateResponse can be used directly as input into the Shipment Request, as both perform similar validations in terms of service capability.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_with_http_info(body, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_version', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version', 'strict_validation', 'bypass_plt_error', 'validate_data_only']  # noqa: E501
        ...
        if ('x_version' not in params or
            ...
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments`")  # noqa: E501
        ...
        if 'validate_data_only' in params:
            query_params.append(('validateDataOnly', params['validate_data_only']))  # noqa: E501
    ...
    def exp_api_shipments_documentimage(self, shipment_tracking_number, shipper_account_number, type_code, pickup_year_and_month, x_version, **kwargs):  # noqa: E501
        """Get Image  # noqa: E501

        The Get Image service can be used to retrieve customer's own uploaded or DHL generated Commercial Invoice, Waybill Document or other supporting documents that was uploaded during shipment creation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_documentimage(shipment_tracking_number, shipper_account_number, type_code, pickup_year_and_month, x_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_shipments_documentimage_with_http_info(shipment_tracking_number, shipper_account_number, type_code, pickup_year_and_month, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_documentimage_with_http_info(shipment_tracking_number, shipper_account_number, type_code, pickup_year_and_month, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_documentimage_with_http_info(self, shipment_tracking_number, shipper_account_number, type_code, pickup_year_and_month, x_version, **kwargs):  # noqa: E501
        """Get Image  # noqa: E501

        The Get Image service can be used to retrieve customer's own uploaded or DHL generated Commercial Invoice, Waybill Document or other supporting documents that was uploaded during shipment creation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_documentimage_with_http_info(shipment_tracking_number, shipper_account_number, type_code, pickup_year_and_month, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['shipment_tracking_number', 'shipper_account_number', 'type_code', 'pickup_year_and_month', 'x_version', 'encoding_format', 'all_in_one_pdf', 'compressed_package', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments_documentimage`")  # noqa: E501
    ...
    def exp_api_shipments_epod(self, shipment_tracking_number, x_version, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_epod(shipment_tracking_number, x_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_shipments_epod_with_http_info(shipment_tracking_number, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_epod_with_http_info(shipment_tracking_number, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_epod_with_http_info(self, shipment_tracking_number, x_version, **kwargs):  # noqa: E501
        """Electronic Proof of Delivery  # noqa: E501

        The electronic proof of delivery service can be used to retrieve proof of delivery for certain delivered DHL Express shipments   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_epod_with_http_info(shipment_tracking_number, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['shipment_tracking_number', 'x_version', 'shipper_account_number', 'content', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments_epod`")  # noqa: E501
    ...
    def exp_api_shipments_img_upload(self, body, x_version, shipment_tracking_number, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_img_upload(body, x_version, shipment_tracking_number, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_shipments_img_upload_with_http_info(body, x_version, shipment_tracking_number, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_img_upload_with_http_info(body, x_version, shipment_tracking_number, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_img_upload_with_http_info(self, body, x_version, shipment_tracking_number, **kwargs):  # noqa: E501
        """Upload Paperless Trade shipment (PLT) images of previously created shipment.  # noqa: E501

        The upload-image service can be used to upload PLT images to a previously created shipment.  The PLT images for the shipment can be uploaded before the shipment has been physically  collected by DHL courier. However, the original shipment must contain WY as the special service otherwise,  an error will be returned when the customer wants to use the reupload function in this upload-image service.     IMPORTANT: Please note that at least 10mins must be given between the initial createShipment request and then  the upload-image request (including subsequent upload-image request).    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_img_upload_with_http_info(body, x_version, shipment_tracking_number, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_version', 'shipment_tracking_number']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments_img_upload`")  # noqa: E501
        # verify the required parameter 'shipment_tracking_number' is set
        if ('shipment_tracking_number' not in params or
                params['shipment_tracking_number'] is None):
    ...
    def exp_api_shipments_invoice_data_awb(self, body, x_version, shipment_tracking_number, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_invoice_data_awb(body, x_version, shipment_tracking_number, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_shipments_invoice_data_awb_with_http_info(body, x_version, shipment_tracking_number, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_invoice_data_awb_with_http_info(body, x_version, shipment_tracking_number, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_invoice_data_awb_with_http_info(self, body, x_version, shipment_tracking_number, **kwargs):  # noqa: E501
        """Upload Commercial Invoice data for your DHL Express shipment  # noqa: E501

        ## Upload Invoice Data with Shipment ID The upload invoice data service can be used to upload Commerical Invoice data with Shipment Identification Number for your DHL Express shipment.Customer can provide Commercial Invoice data before Shipment Data via Create Shipment flow or vice versa.  Important Note: UploadInvoiceData service is not enabled by default and must be requested per customer. Use of this service is only enabled on exceptional basis and DHL Express recommends to submit shipment requests together with a commercial invoice data.To enable use of UploadInvoiceData service, please contact your DHL Express IT representative. To use UploadInvoiceData service, it is required that \"PM\" service code is provided in MyDHL API Create Shipment request. \"PM\" service code is not enabled by  default for the customers, and needs to be enabled upon request.  When Shipment is created via MyDHL API Create Shipment service before uploading the Commercial Invoice (CIN) data,it is mandatory to provide the Shipment Identification Number as received in MyDHL API Create Shipment service Response. When Commercial Invoice (CIN) data is uploaded prior to creating a shipment via MyDHL API Create Shipment service, it is mandatory to provide Invoice Reference Number with Invoice Reference Type value \"CU\" and Shipper Account Number.   These elements are mandatory to facilitate an effective data merge of the Commercial Invoice (CIN) data with Shipment Data. As an output customer will receive Notification element value '0' on successful upload of Commercial Invoice (CIN) data.  DHL backend application performs the subsequent data merging process of the Shipment Data and Commercial Invoice data.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_invoice_data_awb_with_http_info(body, x_version, shipment_tracking_number, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'x_version', 'shipment_tracking_number', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments_invoice_data_awb`")  # noqa: E501
        # verify the required parameter 'shipment_tracking_number' is set
        if ('shipment_tracking_number' not in params or
                params['shipment_tracking_number'] is None):
