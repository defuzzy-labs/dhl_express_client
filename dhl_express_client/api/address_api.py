...
class AddressApi(object):
    ...
    def exp_api_address_validate(self, type, country_code, x_version, **kwargs):  # noqa: E501
        ...
        >>> thread = api.exp_api_address_validate(type, country_code, x_version, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.exp_api_address_validate_with_http_info(type, country_code, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_address_validate_with_http_info(type, country_code, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_address_validate_with_http_info(self, type, country_code, x_version, **kwargs):  # noqa: E501
        """Validate DHL Express pickup/delivery capabilities at origin/destination  # noqa: E501

        Validates if DHL Express has got pickup/delivery capabilities at origin/destination   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_address_validate_with_http_info(type, country_code, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['type', 'country_code', 'x_version', 'postal_code', 'city_name', 'county_name', 'strict_validation', 'message_reference', 'message_reference_date', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        ...
        if ('x_version' not in params or
            ...
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_address_validate`")  # noqa: E501
