...
class TrackingApi(object):
    ...
    def exp_api_shipments_tracking(self, shipment_tracking_number, x_version, **kwargs):  # noqa: E501
        ...
        >>> thread = api.exp_api_shipments_tracking(shipment_tracking_number, x_version, async_req=True)
        >>> result = thread.get()
        ...
        :param bool request_controlled_access_data_codes: Query parameter to request to return values of controlled access code fields in response.
        :param bool request_gmt_offset_per_event: Query parameter to request to return GMT Offset of each event in response, for both shipment level and piece level.
        ...
        :param str accept_language: Format {3-character language code}
        ...
        if kwargs.get('async_req'):
            return self.exp_api_shipments_tracking_with_http_info(shipment_tracking_number, x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_tracking_with_http_info(shipment_tracking_number, x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_tracking_with_http_info(self, shipment_tracking_number, x_version, **kwargs):  # noqa: E501
        """Track a single DHL Express Shipment  # noqa: E501

        The Tracking service retrieves tracking statuses for a single DHL Express Shipment   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_tracking_with_http_info(shipment_tracking_number, x_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['shipment_tracking_number', 'x_version', 'tracking_view', 'level_of_detail', 'request_controlled_access_data_codes', 'request_gmt_offset_per_event', 'message_reference', 'message_reference_date', 'accept_language', 'plugin_name', 'plugin_version', 'shipping_system_platform_name', 'shipping_system_platform_version', 'webstore_platform_name', 'webstore_platform_version']  # noqa: E501
        ...
        if ('x_version' not in params or
            ...
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments_tracking`")  # noqa: E501
        ...
        if 'request_controlled_access_data_codes' in params:
            query_params.append(('requestControlledAccessDataCodes', params['request_controlled_access_data_codes']))  # noqa: E501
        if 'request_gmt_offset_per_event' in params:
            query_params.append(('requestGMTOffsetPerEvent', params['request_gmt_offset_per_event']))  # noqa: E501
    ...
    def exp_api_shipments_tracking_multi(self, x_version, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_tracking_multi(x_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.exp_api_shipments_tracking_multi_with_http_info(x_version, **kwargs)  # noqa: E501
        else:
            (data) = self.exp_api_shipments_tracking_multi_with_http_info(x_version, **kwargs)  # noqa: E501
            return data

    def exp_api_shipments_tracking_multi_with_http_info(self, x_version, **kwargs):  # noqa: E501
        """Track a single or multiple DHL Express Shipments  # noqa: E501

        The Tracking service retrieves tracking statuses for a single or multiple DHL Express Shipments   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.exp_api_shipments_tracking_multi_with_http_info(x_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_version' not in params or
                params['x_version'] is None):
            raise ValueError("Missing the required parameter `x_version` when calling `exp_api_shipments_tracking_multi`")  # noqa: E501
