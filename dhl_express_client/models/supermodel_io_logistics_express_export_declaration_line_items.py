...
class SupermodelIoLogisticsExpressExportDeclarationLineItems(object):
    ...
    def __init__(self, number=None, description=None, price=None, quantity=None, commodity_codes=None, export_reason_type=None, manufacturer_country=None, weight=None, is_taxes_paid=None, customer_references=None, customs_documents=None):  # noqa: E501
