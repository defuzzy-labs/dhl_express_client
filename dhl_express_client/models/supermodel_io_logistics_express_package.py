...
class SupermodelIoLogisticsExpressPackage(object):
    ...
    def __init__(self, type_code=None, weight=None, dimensions=None, customer_references=None, identifiers=None, description=None, label_barcodes=None, label_text=None, label_description=None):  # noqa: E501
